...
#' @examples
#' uni_penn_logo_1
#' unikn::seecol(uni_penn_logo_1, main = "Logo colors Pennsylvania Uni") # view color palette
#'
#' @family university color palettes
#'
#' @seealso
#' \code{\link{uni_penn_web_2}} for web colors of University of Pennsylvania
...
uni_penn_logo_1 <- unikn::newpal(col = c("#011F5B", "#990000"),
                           names = c("penn_blue", "penn_red"),
                           as_df = FALSE)

# # Check:
# unikn::seecol(uni_penn_logo_1, main = "Primary colors University of Pennsylvania", col_bg = "lightgrey")



# - uni_penn_web_2: Web colors ------
...
#' @examples
#' uni_penn_web_2
#' unikn::seecol(uni_penn_web_2, main = "Web colors Pennsylvania Uni") # view color palette
#'
#' @family university color palettes
#'
#' @seealso
#' \code{\link{uni_penn_logo_1}} for logo colors of University of Pennsylvania
#' \code{\link{seecol}} for viewing and comparing color palettes;
#' \code{\link{usecol}} for using color palettes;
#' \code{\link{simcol}} for finding similar colors;
#' \code{\link{newpal}} for defining new color palettes;
...
uni_penn_web_2 <- unikn::newpal(col = c("#011F5B", "#990000", "#82AFD3", "#C35A00", "#008e00", "#F2C100", "#4A0042", "#F2F2F2", "#F7F7F7", "#CCCCCC", "#999999", "#333333"),
                           names = c("penn_blue", "penn_red", "penn_blue2", "penn_orange", "penn_green", "penn_yellow", "penn_purple", "penn_grey1", "penn_grey2", "penn_grey3", "penn_grey4", "penn_black"),
                           as_df = FALSE)

# # Check:
# unikn::seecol(uni_penn_web_2, main = "Accent colors University of Pennsylvania", col_bg = "lightgrey")
